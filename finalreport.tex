...
\label{sec:org124d61a}
\subsection{Information from Pelegrina et. Al (2015)}
\label{sec:org455ba38}
\cite{NormativeData}
1

\subsection{Python Code For}
\label{sec:org066c509}
\subsection{R-code}
\label{sec:org7d68e89}
\subsection{Inline usage}
\label{sec:org3226767}

\section{Results}
\label{sec:orgf12252e}
\subsection{Table}
\label{sec:orgc9b86c7}
\subsection{Simple summary statistics}
\label{sec:org78e10bb}
\subsection{2 plots}
\label{sec:orgee7ef18}

\section{Discussion}
\label{sec:orga2fca33}

\section{Bibliography}
\label{sec:org4562ee4}
need to add the fpsyg-06-01544 citation!
\bibliography{references}

\section{Appendix}
\label{sec:orgf11f30b}
\subsection{Python Code for n-back test}
\label{sec:orgb590c99}
\begin{verbatim}
