...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.78.01), February 24, 2014, at 12:34
...
expName = 'N-Back_v.1_demo_with_error'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Administrator\\Desktop\\Robust_Tasks\\task_files\\N-Back_psychopy\\N-Back_v.1_demo_with_error.psyexp',
...
BlocksLoop = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath='C:\\Users\\Administrator\\Desktop\\Robust_Tasks\\task_files\\N-Back_psychopy\\N-Back_v.1_demo_with_error.psyexp',
...
for thisBlocksLoop in BlocksLoop:
    ...
    for thisBack0Loop in Back0Loop:
        ...
        for thisBack0TrialsLoop in Back0TrialsLoop:
            ...
            routine_0_BackComponents.append(text_6)
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                elif text_6.status == STARTED and t >= (0.0 + 2):
                    text_6.setAutoDraw(False)
                if text_6.status == STARTED:  # only update if being drawn
                    text_6.setText('ERROR', log=False)
                    text_6.setPos([errorXpos, 0], log=False)
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif text_5.status == STARTED and t >= (0.0 + 10):
    ...
    for thisBack2Loop in Back2Loop:
        ...
        for thisBack2TrialsLoop in Back2TrialsLoop:
            ...
            routine_2_BackComponents.append(text_2)
            ...
            while continueRoutine and routineTimer.getTime() > 0:
                ...
                elif text_2.status == STARTED and t >= (0.0 + 2):
                    text_2.setAutoDraw(False)
                if text_2.status == STARTED:  # only update if being drawn
                    text_2.setText('ERROR', log=False)
                    text_2.setPos([errorXpos, 0], log=False)
